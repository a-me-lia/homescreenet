...
useEffect(()=>{
  ...
  if(text == ''){setError("A message is required!");return;}
  } 
...
<section>
      ...
      >
        ...
        } type="submit" className={`${canSubmit?'bg-black text-white border-white hover:bg-slate-700' : 'bg-gray-200 text-gray-600'} border-2 py-2`}>Send</button>
      </form>
      {error != '' && (
